...
import { getValidationTimeout, pickActualValue, parseRGBColor, isColorInRange } from '../helpers/utils';
...
export const validate_computed_styles = defineTabTool({
  ...
  handle: async (tab, rawParams, response) => {
    ...
    await tab.waitForCompletion(async () => {
      ...
      try {
        console.error('computed styles timeout:', getValidationTimeout(tab.context));
