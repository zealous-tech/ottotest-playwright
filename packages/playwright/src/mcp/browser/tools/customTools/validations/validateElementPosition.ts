  ...
  handle: async (tab, params, response) => {
    ...
    await tab.waitForCompletion(async () => {
      ...
      try {
        ...
        try {
          await expect(locator1).toBeAttached({ timeout: getValidationTimeout(tab.context) });
        } catch (error) {
        ...
        try {
          await expect(locator2).toBeAttached({ timeout: getValidationTimeout(tab.context) });
        } catch (error) {
